 ...
 * =====================================
 */
public class JCameraView2 extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView {
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView2(Context context) {
        this(context, null);
    }

    public JCameraView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JCameraView2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            @Override
            public void run() {
                CameraInterface.getInstance().doOpenCamera(JCameraView2.this);
            }
        }.start();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void playVideo(Bitmap firstFrame, final String url) {
        videoUrl = url;
        JCameraView2.this.firstFrame = firstFrame;
     ...
     * @param hine
     */
    public void hintAllIcon(boolean hine){
