...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	private void showSaveDialog(final Bitmap resource) {
		...
		window.setLayout(ViewGroup.LayoutParams.MATCH_PARENT,dip2px(this, 112));
		...
		view.findViewById(R.id.tv_save_image).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				EaseImageUtils.saveImageToGallery(EaseShowBigImageActivity.this,resource);
				Toast.makeText(EaseShowBigImageActivity.this, "图片已保存到系统相册", Toast.LENGTH_SHORT).show();
				dialog.dismiss();
			}
		});
