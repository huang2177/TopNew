...
//        messageList.setAvatarShape(1);
            ...
            public boolean onPressToSpeakBtnTouch(View v, MotionEvent event) {
                return voiceRecorderView.onPressToSpeakBtnTouch(v, event, new EaseVoiceRecorderCallback() {
                    ...
                    public void onVoiceRecordComplete(String voiceFilePath, int voiceTimeLength) {
                        ...
                        Log.e("tag","=============  voiceFilePath : " + voiceFilePath + "   voiceLength: " + voiceTimeLength);
                    }
                });
            }
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.icon_more);
        ...
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onUserAvatarClick(EMMessage message) {
                if (chatFragmentHelper != null) {
                    chatFragmentHelper.onAvatarClick(message);
                }
            }
    ...
    protected void sendRedbagMessage(String content, String redId) {
        EMMessage message = EMMessage.createTxtSendMessage(content, toChatUsername);
        message.setAttribute(EaseConstant.REDBAG_ID, redId);
        sendMessage(message);
    }
...
//        message.setAttribute(NICK_NAME, nickname);
    ...
    public interface EaseChatFragmentHelper {
         ...
         * @param message
         */
        void onAvatarClick(EMMessage message);
