...
public class PreferenceManager {
	...
	public void setClickRedbagId(String redbagId){
		editor.putString(redbagId,"");
		editor.apply();
	}

	public String getClickRedbagId(String redbagId){
		return mSharedPreferences.getString(redbagId,"");
	}
