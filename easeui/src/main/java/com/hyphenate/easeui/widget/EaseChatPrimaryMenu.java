...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    public void onClick(View view){
        ...
        if (id == R.id.btn_send) {
            ...
            boolean p = PermissionUtils.checkRequestPermissionResult(getContext(), Manifest.permission.RECORD_AUDIO);
            if (!p){
                PermissionUtils.applyPermission(activity,new String[]{Manifest.permission.RECORD_AUDIO});
            }else {
                setModeVoice();
                showNormalFaceImage();
                if(listener != null)
