...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowRedbag;
...
public class EaseChatRedbagPresenter extends EaseChatRowPresenter {

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowRedbag(cxt,message,position,adapter);
    }
