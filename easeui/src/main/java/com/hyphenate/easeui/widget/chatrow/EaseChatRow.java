...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(userAvatarView != null) {
            ...
            try {
                String headurl = message.getStringAttribute(EaseConstant.HEAD_URL);
                String nickname = message.getStringAttribute(EaseConstant.NICK_NAME);
                Log.e("tag","===============  headurl " + headurl + "   name " + nickname);
                if (message.direct() == Direct.SEND) {
                    EaseUserUtils.setCustomUserAvatar(context, headurl, userAvatarView);
                } else {
                    EaseUserUtils.setCustomUserAvatar(context, headurl, userAvatarView);
