...
import com.kw.top.R;
import com.kw.top.bean.chat.InviteMessage;
import com.kw.top.bean.chat.RobotUser;
import com.kw.top.bean.event.RefreshNewsEvent;
import com.kw.top.db.DemoDBManager;
import com.kw.top.db.InviteMessgeDao;
import com.kw.top.db.UserDao;
import com.kw.top.parse.UserProfileManager;
import com.kw.top.receiver.HeadsetReceiver;
import com.kw.top.ui.activity.NewMainActivity;
import com.kw.top.ui.activity.news.ChatActivity;
import com.kw.top.utils.DemoModel;
...
//                break;
    ...
    protected void onUserException(String exception) {
        ...
        Intent intent = new Intent(appContext, NewMainActivity.class);
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                ...
                for (EMMessage message : messages) {
                    ...
                    if (!easeUI.hasForegroundActivies()) {
                        EventBus.getDefault().post(new RefreshNewsEvent(true));
                        Log.e("tag", "================  发送消息");
