...
public class UserProfileActivity extends MyEaseBaseActivity implements OnClickListener{
			...
			public void onSuccess(EaseUser user) {
				if (user != null) {
					...
					if(!TextUtils.isEmpty(user.getAvatar())){
						 Glide.with(UserProfileActivity.this).load(HttpHost.qiNiu + user.getAvatar()).apply(GlideTools.getHeadOptions()).into(headAvatar);
					}else{
					    Glide.with(UserProfileActivity.this).load(R.mipmap.icon_default_head).into(headAvatar);
					}
				}
			}
